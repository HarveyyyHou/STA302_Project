...
#| warning: false
#| message: false
data <- read.csv("/Users/zhouxuanle/Desktop/2025winter/STA302/STA302 project 1/STA302 Part 1 Submission/STA302_original_dataset.csv")
...
df_clean <- read.csv("/Users/zhouxuanle/Desktop/2025winter/STA302/STA302 project 1/STA302 Part 1 Submission/cleaned_data_school.csv")
...
model_OneLessPredictor <- lm(OSSLT_Sqrt ~ School_Language + Special_Ed_Pct + Low_Income_Transform + No_Edu_Transform, data = df_clean)
