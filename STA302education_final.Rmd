...
$R^2$, AIC, BIC, RSS, F and P value all improved for models that has the Squared Special Education predictor. For models where we drop school type, all metrics does not differ by much, indicating that this predictor has minimal impact on the model, or no relationships. Finally, we can conclude the final model with 5 Predictors: School Language, Special Education Proportion, Special Education Squared, Low Income Proportion, Parents with minimal education proportion.
```{R}
...
Both graphs improved with no outliers near the bound of scales. Less Deviation observed from the left.
```{r residual-plots}
...
full_table[, c("term", "Estimate", "Std. Error", "t value", "Pr(>|t|)", "Lower 95% CI", "Upper 95% CI")] %>%
  kable(
    ...
    caption = "Final Regression Model Coefficients",
    escape = FALSE,
    booktabs = TRUE,
    align = "lcccccc"
  ) %>%
